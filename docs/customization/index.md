...
## General
[Awema.PL](https://www.awema.pl) provides a default theme [Indigo Layout](https://www.awema.pl/documentation/components/indigo-layout) and allows to customize some basic aspects in order to meet the needs of UI diversity from business and brand.

**Awema.PL** uses [Stylus](http://stylus-lang.com/) as developing a language of styles. We  have defined a set of 
...
1. Please install a module `composer require awema-pl/indigo-layout`
...
[Indigo 
Layout](https://www.awema.pl/documentation/components/indigo-layout) 
4. Example:
...
<p align="center">
  <img src="https://static.awema.pl/docs/stripe2.jpg" alt="Stripe - Awema.PL" />
</p>
...
<p align="center">
  <img src="https://static.awema.pl/docs/google2.jpg" alt="Google - Awema.PL" />
</p>
