...
![modal-window](/assets/awema-pl/wiki/docs/modal.gif)
...
The properties, marked as **globally configured**, could be provided in `AWEMA_CONFIG` in camelCase. For example:
