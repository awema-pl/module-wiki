...
Base.js loads Vue, Vuex and Vue Router asyncronously and creates a root Vue instance if it founds a tag with `id="awema-app"`
...
<html>
    <head>
        ...
        <!-- JS-core script -->
        <script src="https://cdn.pkgkit.com/{pkgkit.com CDN key}/awema-pl/base-js/v1.x.x/js/main.js"></script>
    </head>
    <body>
